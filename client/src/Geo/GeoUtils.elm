...
import Math.Vector3 as V3 exposing (Vec3, cross, getX, getY, getZ, negate, normalize, vec3)
...
linePerpendicularToBearing (Meters lineLength) origin (Bearing b) =
    let
        ...
        lp1 =
            destination (addDeg (Deg 90) b |> bearingFromDeg) radius origin
