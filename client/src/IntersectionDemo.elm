...
selectPoint p model =
  if isNothing model.p1 
  then { model | p1 = Just p }
  else if isNothing model.p2
  then { model | p2 = Just p }
  else if isNothing model.p3
  then { model | p3 = Just p }
  else if isNothing model.p4
  then { model | p4 = Just p}
  else model 
