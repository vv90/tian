...
import PlaybackState exposing (PlaybackState, advancePlaybackState, initPlaybackState, setSpeed, start, stop)
...
update msg model =
    case msg of
        ...
        PlaybackTick _ ->
            let
                ( nextPoint, nextPlaybackState ) =
                    advancePlaybackState model.playbackState
            in
            ( { model
